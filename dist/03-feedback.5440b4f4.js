...
let userData = {};
form.addEventListener("input", (0, _lodashThrottleDefault.default)(onInputValue, 2000));
...
function fillContactFormElements() {
    ...
    for (let key of form)if (userDataFromLS.hasOwnProperty(key.name)) userData[key.name] = key.value = userDataFromLS[key.name];
}
